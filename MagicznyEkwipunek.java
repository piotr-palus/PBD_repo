...
public class MagicznyEkwipunek
{
	...
	String[] przedmioty = {"Buty", "Napier�nik", "Pier�cie�", "Kolczyk", "Sztylet", "Medalion"};
	String[] atuty = {"�ycia", "Roztropno�ci", "Charyzmy", "Niewidzilno�ci", "Zr�czno�ci", "Budowy", "Many", "Si�y", "Inteligencji"};
